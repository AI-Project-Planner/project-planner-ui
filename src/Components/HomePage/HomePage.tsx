  ...
  return (
    <section className='home'>
      ...
      <section className='popup'>
        ...
        <div className='project-info-container'>{!smallScreen && <p className='project-info'>An application designed to streamline the project planning process for developers by leveraging advanced AI technology to craft comprehensive project plans and generate innovative ideas!</p>}</div>
        <section className='popup-buttons-container'>
          <Link to='/tutorial' className='popup-button'>
            View Tutorial
          </Link>
          <Link className='popup-button' to='/form'>
